#
#  Be sure to run `pod spec lint PCStackNavigationController.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   PCStackNavigationController is a different kind of navigation controller.

                   It's great for using with a card-style UI. Cards (view controllers) can easily be pushed, popped, and revealed with simple up/down swipe gestures similar to Apple's iOS Reminders UI.
                   DESC
  ...
  # Or just: s.author    = ""
  # s.authors            = { "" => "gilesvangruisen@me.com" }
